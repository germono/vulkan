...
public class VertexTexture {
    ...
    public static final int SIZEOF = (3 + 2) * Float.BYTES;
    static final int OFFSETOF_POS = 0;
    static final int OFFSETOF_TEXTCOORDS = (3 ) * Float.BYTES;

    public Vector3fc pos;
    public Vector2fc texCoords;

    public VertexTexture(Vector3fc pos,  Vector2fc texCoords) {
        this.pos = pos;
    ...
    public static VkVertexInputBindingDescription.Buffer getBindingDescription() {
        ...
        bindingDescription.stride(VertexTexture.SIZEOF);
